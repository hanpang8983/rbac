...
<div class="formbody">
    ...
    <ul class="forminfo">
        ...
        <li><label>描述</label><textarea name="role.role_desc" id="role_desc" cols="" rows="" class="textinput">${role.role_desc}</textarea></li>
        <li><label>&nbsp;</label><input type="button" class="btn" value="确认更新" onclick="toSub();"/></li>
        <li><label>&nbsp;</label><img src="<%=path %>/upload/role/${role.photo}"/></li>
    </ul>
    <!-- 隐藏域 -->
